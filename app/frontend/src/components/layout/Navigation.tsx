...
import { AppBar, Toolbar, Button, Box, Typography, IconButton, Avatar, Badge, Menu, MenuItem, Divider, ListItemIcon, Tooltip } from '@mui/material';
import { Home, School, Assessment, TrendingUp, Logout, Brightness4, Brightness7, Notifications, Settings, Person } from '@mui/icons-material';
